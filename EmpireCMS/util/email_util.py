...
def send_mail(attachments_report_name, receiver, subject, content):
    try:
        ...
        #授权码XNJOQQYGOWLLYPFT
        yag = yagmail.SMTP(user="xxx@163.com", password="", host="smtp.163.com", encoding='GBK')
...
if __name__ == "__main__":
    send_mail("E:\\CMS_HT\\Test_framework_UIKeywords_002\\log\\ui_test.log", "xxxx@qq.com", "测试邮件", "正文")
